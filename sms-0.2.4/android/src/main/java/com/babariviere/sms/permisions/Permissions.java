...
public class Permissions {
    ...
    {
        //TODO:: remove (activity == null) permission bypass
        return activity == null || (Build.VERSION.SDK_INT < Build.VERSION_CODES.M || activity.checkSelfPermission(permission) == PackageManager.PERMISSION_GRANTED);
