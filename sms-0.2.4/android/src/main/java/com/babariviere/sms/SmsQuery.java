...
class SmsQueryHandler implements RequestPermissionsResultListener {
  ...
  private final String[] permissionsList = new String[] { Manifest.permission.READ_SMS, Manifest.permission.SEND_SMS,
...
//          cv.put("read",true);
//          registrar.context().getContentResolver().update(Uri.parse("content://sms/inbox"),cv,"_id="+cursor.getLong(cursor.getColumnIndex("_id")),null);
       // }
